...
public class PojoTest {
	...
	public void test_pojo_structure_and_behavior() {
		List<PojoClass> pojoClasses = PojoClassFactory.getPojoClasses("com.att.sales.nexxus.accesspricing.model");
		
		List<PojoClass> pojoClasses1 = PojoClassFactory.getPojoClasses("com.att.sales.nexxus.userdetails.model");
