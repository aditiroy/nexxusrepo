package com.att.sales.nexxus.myprice.publishValidatedAddresses.modelTest;
...
public class PojoTest {
	...
	public void test_pojo_structure_and_behaviour() {
		List<PojoClass> pojoClasses = PojoClassFactory.getPojoClasses("com.att.sales.nexxus.myprice.publishValidatedAddresses.model");
