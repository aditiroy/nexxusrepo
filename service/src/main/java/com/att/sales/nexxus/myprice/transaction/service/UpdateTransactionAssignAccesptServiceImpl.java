...
@Service("updateTransactionAssignAccesptServiceImpl")
public class UpdateTransactionAssignAccesptServiceImpl extends BaseServiceImpl implements UpdateTransactionAssignAccesptService {
	...
	@Override
	public ServiceResponse updateTransactionassignAccesptService(LinkedHashMap<String, Object> requestMap)
			throws SalesBusinessException {
		logger.info("Entering updateTransactionassignAccesptService() method");
		...
		try {
			...
			String uri = env.getProperty("myprice.updateTransactionAssignAccept").replace("{transactionId}", myPriceTransId);
		...
		logger.info("Exiting updateTransactionassignAccesptService() method");
		return response;
	}
