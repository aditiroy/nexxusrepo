...
/**
 * The Class PddmSubscriptionStatusRequest.
 *
 * @author RudreshWaladaunki
 */
@Component
@JsonSerialize(include = Inclusion.NON_NULL)
public class PddmSubscriptionStatusRequest {
	 ...
	 *
	 * @param msApplication the msApplication to set
	 */
	 ...
	 *
	 * @param salesPddmId the salesPddmId to set
	 */
